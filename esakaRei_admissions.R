### Rei Esaka
### Trinity Admissions Assignment
### November 20, 2021

### Referenced Dr. Jorge Colazo's code (Trinity University)

### Objective: We were given Trinity University admissions data, and we were to predict who is going
### to take the offer of admission from Trinity. This can allow admissions officers to follow up and
...
###### Editing the Contents of a Column
      ...
      # For the full ride scholarships, I'll take the average Trinity tuition from the past 5 years
...
###### Dropped Columns 
     ...
     # Trinity, being a liberal arts college, should only care about the ACT composite scores rather than the scores in the separate
     ...
     # Delete the SAT-related columns because on the Admissions features doc, it describes that Trinity uses "ACT scores or a
     # SAT converted to ACT score to calculate the Merit Award, in addition to the Recalculated GPA".
      ...
      # similar situation with first source origin first source summary
        ...
        raw_data <- raw_data %>% dplyr::select(-Religion) # trinity is nonreligious
